...
#[AsCommand(
    name: 'app:version:referentiel',
    description: 'Genere le fichier de version de la partie référentiel de formation',
)]
class VersionReferentielCommand extends Command
{
    ...
    {
        $this->baseDir = $kernel->getProjectDir() . '/public/version-referentiel/';
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($specialites as $specialite) {
            ...
            $tabJson = $this->departementExport->genereJsonReferentiel($specialite);
            $name = 'but-referentiel-' . $specialite->getSigle().
                '-' . $specialite->getNumeroAnnexe().'-2022';
