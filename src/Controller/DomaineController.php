...
{
    #[Route('/', name: 'administration_domaine_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'administration_domaine_new', methods: ['GET', 'POST'])]
    public function new(Request $request, DomaineRepository $domaineRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('administration_domaine_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'administration_domaine_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'administration_domaine_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'administration_domaine_delete', methods: ['POST'])]
