...
//{
//    private const LATEX_PLACEHOLDERS = [
//        '∫' => '###LATEX_INT###',
//        '∑' => '###LATEX_SUM###',
//        '∞' => '###LATEX_INFTY###',
//        '≈' => '###LATEX_APPROX###',
...
//    ];
//
//    private const LATEX_PLACEHOLDER_REPLACEMENTS = [
//        '###LATEX_INT###' => '\ensuremath{\int}',
//        '###LATEX_SUM###' => '\ensuremath{\sum}',
//        '###LATEX_INFTY###' => '\ensuremath{\infty}',
//        '###LATEX_APPROX###' => '\ensuremath{\approx}',
//        '###LATEX_SIMEQ###' => '\ensuremath{\simeq}',
//        '###LATEX_EQUIV###' => '\ensuremath{\equiv}',
//        '###LATEX_LEQ###' => '\ensuremath{\leq}',
//        '###LATEX_GEQ###' => '\ensuremath{\geq}',
//        '###LATEX_NEQ###' => '\ensuremath{\neq}',
//        '###LATEX_PM###' => '\ensuremath{\pm}',
//        '###LATEX_TIMES###' => '\ensuremath{\times}',
//        '###LATEX_DIV###' => '\ensuremath{\div}',
//        '###LATEX_SQRT###' => '\ensuremath{\sqrt{\ }}',
//        '###LATEX_PI###' => '\ensuremath{\pi}',
//        '###LATEX_DELTA###' => '\ensuremath{\Delta}',
//        '###LATEX_DELTA_LOW###' => '\ensuremath{\delta}',
//        '###LATEX_ALPHA###' => '\ensuremath{\alpha}',
//        '###LATEX_BETA###' => '\ensuremath{\beta}',
//        '###LATEX_GAMMA###' => '\ensuremath{\gamma}',
//        '###LATEX_LAMBDA###' => '\ensuremath{\lambda}',
//        '###LATEX_MU###' => '\ensuremath{\mu}',
//        '###LATEX_OMEGA###' => '\ensuremath{\Omega}',
//        '###LATEX_OMEGA_LOW###' => '\ensuremath{\omega}',
//        '###LATEX_DEGREE###' => '\ensuremath{^\circ}',
//    ];
//
...
//        }
//
//        $text = $this->protectLatexSymbols($text);
//
//        $text = str_replace(
//            ['\\', '&', '%', '$', '#', '_', '{', '}', '~', '^', 'œ', 'Œ', 'æ', 'Æ', '...'],
//            [
...
//        );
//
//        return $this->restoreLatexSymbols($text);
//    }
//
...
//        $text = $this->replaceRemainingNonAsciiForLatexDocument($text);
//
//        return $this->restoreLatexSymbols($text);
//    }
//
//    private function protectLatexSymbols(string $text): string
//    {
//        return strtr($text, self::LATEX_PLACEHOLDERS);
//    }
//
//    private function restoreLatexSymbols(string $text): string
//    {
//        return strtr($text, self::LATEX_PLACEHOLDER_REPLACEMENTS);
//    }
//
...
//            return $this->isContinuationByte(ord($text[$index + 1])) ? 2 : 0;
//        }
//
//        if ($first >= 0xE0 && $first <= 0xEF && $index + 2 < $length) {
//            return $this->isContinuationByte(ord($text[$index + 1]))
//            && $this->isContinuationByte(ord($text[$index + 2])) ? 3 : 0;
//        }
//
//        if ($first >= 0xF0 && $first <= 0xF4 && $index + 3 < $length) {
//            return $this->isContinuationByte(ord($text[$index + 1]))
//            && $this->isContinuationByte(ord($text[$index + 2]))
//            && $this->isContinuationByte(ord($text[$index + 3])) ? 4 : 0;
//        }
//
//        return 0;
//    }
...
//        }
//
//        return $this->restoreLatexSymbols(str_replace($search, $replace, $text));
//    }
//
...
final class LatexSanitizer
{
    ...
    public function normalizeUnicode(?string $text): string
    {
        ...
        $text = str_replace(
            [
                "\u{03C6}","\u{03C9}","\u{1F9E0}","\u{2082}","\u{00A0}", "\u{1680}", "\u{2000}", "\u{2001}", "\u{2002}", "\u{2003}", "\u{2004}", "\u{2005}", "\u{2006}", "\u{2007}", "\u{2008}", "\u{2009}", "\u{200A}", "\u{202F}", "\u{205F}", "\u{3000}",
                "\u{200B}", "\u{200C}", "\u{200D}", "\u{2060}", "\u{FEFF}",
                "\u{00AD}",
                "\u{2028}", "\u{2029}",
                '’', '‘', '‛', 'ʼ',
